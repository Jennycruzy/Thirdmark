...
- Decision: Wave 1 uses CAC company RC numbers only. The adapter is suitable for the buildathon demonstration; production use should migrate to an authorized CAC VAS integration when available.
